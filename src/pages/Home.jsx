...
- And give the whole code in a single HTML file.
  ...
  const downnloadFile = () => {
    ...
    const fileName = "CompAI-Code.html"
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 
        ...
        {/* Left Section */}
        <div className="w-full py-4 sm:py-6 rounded-xl bg-[#141319] mt-5 p-4 sm:p-5">
        ...
        <div className="relative mt-2 w-full 
                ...
                bg-[#141319] rounded-xl overflow-hidden flex flex-col">
          {
            !outputScreen ? (
              ...
              <>
                {/* Tabs */}
                <div className="bg-[#17171C] w-full h-[45px] sm:h-[50px] flex items-center gap-2 px-2 sm:px-3">
                  <button
                    onClick={() => setTab(1)}
                ...
                {/* Toolbar */}
                <div className="bg-[#17171C] w-full h-[45px] sm:h-[50px] flex items-center justify-between px-2 sm:px-4">
                ...
                <div className="flex-1 overflow-hidden">
                  {tab === 1 ? (
                    <Editor 
                        ...
                        language="html" 
                        options={{
                          fontSize: 12,   // mobile friendly
                          minimap: { enabled: false } // improves mobile UX
                        }}
                      />
                  ) : (
